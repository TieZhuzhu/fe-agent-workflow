...
version: 1.0.1
description: 从 OpenAPI/Swagger（JSON/YAML/URL）生成 types 与 services 并联调页面绑定。 用户说 OpenAPI、Swagger、openapi.json、按接口文档自动生成类型时触发；优先于 api-integration。
---
# OpenAPI 接口联调
