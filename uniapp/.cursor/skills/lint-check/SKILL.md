...
name: lint-check
version: 1.0.1
description: ESLint 检查与修复。重构、大批量改码、feature 交付后执行；修复未使用引入、no-unused-vars 等 lint 错误。用户说「lint」「eslint」「未使用引入」时触发；rules-refactor / code-normalize / feature-verify / incremental-feature 完成后自动衔接。
---
# Lint 检查与修复
