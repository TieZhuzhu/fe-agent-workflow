...
3. `python3 scripts/skills-version.py sync`
4. 更新 [README.md](../README.md) 路由表
5. [CHANGELOG.md](../CHANGELOG.md) 记 Added
6. 若属 ingest/workflow，更新 [feature-dev-workflow](../feature-dev-workflow/SKILL.md) 输入识别表
